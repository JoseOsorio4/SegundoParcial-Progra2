...
public final class VentanaPrincipal extends JFrame {
    ...
    private final JComboBox<EstadoCita> campoEstado =
            new JComboBox<>(EstadoCita.values());

    private final JCheckBox campoRequiereConfirmacion =
            new JCheckBox("Requiere confirmación por llamada");

    private final JButton botonNuevo =
            new Estilos.Boton(
                    "Nuevo / Limpiar",
                    IconoVector.Tipo.MAS,
                    Estilos.SECUNDARIO,
                    Estilos.SECUNDARIO,
                    Estilos.SECUNDARIO,
                    false);
    ...
    private final JButton botonEliminar =
            new Estilos.Boton(
                    "Eliminar",
                    IconoVector.Tipo.PAPELERA,
                    Estilos.PELIGRO,
                    Estilos.PELIGRO_HOVER,
                    Color.WHITE,
                    true);
    ...
    private final JTable tabla = new JTable(modeloTabla) {
        ...
        public Component prepareRenderer(
            ...
            Component componente =
                    super.prepareRenderer(renderer, fila, columna);
    ...
    private final ChipEstadistica chipPendientes =
            new ChipEstadistica(
                    "Pendientes",
                    new Color(251, 191, 36));

    private final ChipEstadistica chipConfirmadas =
            new ChipEstadistica(
                    "Confirmadas",
                    new Color(74, 222, 128));

    private final ChipEstadistica chipCanceladas =
            new ChipEstadistica(
                    "Canceladas",
    ...
    public VentanaPrincipal(CitaServicio servicio) {
        ...
        this.servicio = Objects.requireNonNull(
                servicio,
                "El servicio de citas no puede ser null");
    ...
    private void construirInterfaz() {
        ...
        contenido.setPreferredSize(
                new Dimension(1080, 740));
    ...
    private JPanel construirEncabezado() {
        ...
        JLabel titulo =
                new JLabel(
                        "Agenda de citas",
                        new Estilos.IconoSwing(
                                IconoVector.Tipo.CALENDARIO,
                                24,
                                Color.WHITE),
                        SwingConstants.LEFT);
        ...
        JLabel descripcion =
                new JLabel(
                        "Registra servicios, organiza horarios y controla el estado de cada cita.");

        descripcion.setForeground(
                new Color(232, 232, 250));

        descripcion.setBorder(
                BorderFactory.createEmptyBorder(
                        8,
                        2,
                        0,
    ...
    private JPanel construirFormulario() {
        ...
        campoRequiereConfirmacion.setOpaque(false);

        campoRequiereConfirmacion.setForeground(
                Estilos.TEXTO);

        agregarCampo(
                campos,
                "Cliente",
                IconoVector.Tipo.USUARIO,
                campoCliente,
                0,
                0);
        ...
        JLabel formato =
                new JLabel(
                        "Formato: día/mes/año hora:minuto en 24 horas");
        ...
        campoFechaHora.setToolTipText(
                "Ejemplo: 19/09/2026 14:30. Las citas nuevas deben ser futuras.");

        campoDuracion.setToolTipText(
                "Número entero de minutos, mayor que cero.");

        campoEstado.setToolTipText(
                "Las citas nuevas comienzan pendientes. Selecciona una cita para cambiar su estado.");

        campoRequiereConfirmacion.setToolTipText(
                "Marca esta opción si la cita requiere confirmación por llamada.");
        ...
        campoFechaHora
                .getAccessibleContext()
                .setAccessibleName(
                        "Fecha y hora, día mes año y hora de 24 horas");
    ...
    private JPanel construirListado() {
        ...
        tabla.setToolTipText(
                "Un clic para editar. Doble clic para ver el detalle completo.");
    ...
    private void conectarEventos() {
        ...
        campoCliente.setName(
                "campoCliente");

        campoFechaHora.setName(
                "campoFechaHora");

        campoServicio.setName(
                "campoServicio");

        campoDuracion.setName(
                "campoDuracion");

        campoEstado.setName(
                "comboEstado");

        campoRequiereConfirmacion.setName(
                "checkRequiereConfirmacion");
        ...
        botonGuardar.setName(
                "botonGuardar");

        botonActualizar.setName(
                "botonActualizar");
        ...
        botonNuevo.addActionListener(
                evento -> {
                    ...
                    etiquetaEstado.setText(
                            "Formulario listo para registrar una cita nueva.");
    ...
    private void mostrarDetalle(Cita cita) {
        ...
        DetalleCitaDialog dialogo =
                new DetalleCitaDialog(
                        this,
                        cita,
                        FORMATO_FECHA,
    ...
    private void cargarCitaEnFormulario(
        ...
        campoRequiereConfirmacion.setSelected(
        ...
        etiquetaModo.setText(
                "Modifica los datos y pulsa Actualizar. Para cancelar, elige el estado Cancelada.");
    ...
    private void limpiarFormulario() {
        ...
        etiquetaModo.setText(
                "Completa todos los campos. Las citas nuevas se guardan en estado Pendiente.");
    ...
    private Cita leerFormulario(
        ...
        if (campoServicio
            ...
            throw new IllegalArgumentException(
                    "Escribe el servicio de la cita.");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Escribe una fecha y hora válidas con el formato dd/MM/aaaa HH:mm.\n"
        ...
        ejecutar(
                ...
                actualizada -> {
                    ...
                    if (actualizada) {
                        ...
                        refrescarLista(
                                "La cita ya no estaba disponible. Listado actualizado.");
                    }
                });
    }
    ...
    private void eliminar() {
        ...
        int respuesta =
                JOptionPane.showConfirmDialog(
                        this,
                        "¿Eliminar definitivamente la cita #"
                                + id
                                + "?\n"
    ...
    private void actualizarResumen(
        ...
        chipPendientes.setValor(
                pendientes);

        chipConfirmadas.setValor(
                confirmadas);

        chipCanceladas.setValor(
                canceladas);
    }
        ...
        new SwingWorker<T, Void>() {
            ...
            protected void done() {
                ...
                try {
                    ...
                    mostrarError(
                            "La operación fue interrumpida. Pulsa Refrescar antes de intentarlo de nuevo.");
                    ...
                    if (causa instanceof ValidacionException) {
                        ...
                        String detalle =
                                causa instanceof PersistenciaException
                                        ? causa.getMessage()
    ...
    private void establecerOcupado(
            boolean nuevoEstado) {
    ...
    private void actualizarControles() {
        ...
        campoRequiereConfirmacion.setEnabled(
                !ocupado);
    ...
    private void mostrarError(
        ...
        etiquetaEstado.setText(
                "No se pudo completar la operación. Revisa el mensaje e intenta nuevamente.");
    ...
    private void prepararAnimacionApertura() {
        ...
        try {
            ...
            // El entorno gráfico no admite ventanas translúcidas.
        }
    }
        ...
        temporizador.addActionListener(
                evento -> {
                    ...
                    try {
                        ...
                        // Se ignora si no admite opacidad variable.
                    }
    ...
    private static final class ChipEstadistica
            extends JPanel {
    ...
    private static final class FechaRenderer
    ...
    private static final class DuracionRenderer
            extends DefaultTableCellRenderer {
    ...
    /** Dibuja el estado como una insignia de color en vez de solo texto. */
    private static final class EstadoRenderer
            extends DefaultTableCellRenderer {

        private static final long serialVersionUID = 1L;

        private Color colorPildora =
                Estilos.SECUNDARIO;
